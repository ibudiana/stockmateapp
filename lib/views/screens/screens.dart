...
part 'setting/notification_settings_screen.dart';
part 'setting/settings_screen.dart';
part 'setting/edit_profile_screen.dart';
part 'setting/language_screen.dart';
part 'setting/change_password_screen.dart';
